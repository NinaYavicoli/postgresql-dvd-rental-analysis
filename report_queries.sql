-- this is my full report without any statements for testing -- 

-- User defined function 1: converts rental duration to SMALLINT days -- 
...
-- user defined function 2: converts to text YYYY-MM -- 
